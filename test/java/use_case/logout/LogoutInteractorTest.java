...
class LogoutInteractorTest {
    ...
    @Test
    void successTest() {
        LogoutInputData inputData = new LogoutInputData("sarahhira");
        DataAccessInterface userRepository = new DataAccessInterface();

        // For the success test, we need to add Paul to the data access repository before we log in.
        UserFactory factory = new CommonUserFactory();
        User user = factory.create("Sarah", "sarahhira", "password", "test@gmail.com");
        userRepository.save(user);
        userRepository.setCurrentUsername("sarahhira");
